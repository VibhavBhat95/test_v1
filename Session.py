...
#streamlit run filename after locating the file from anaconda prompt
...
st.image('house.jpg')
st.video('https://youtu.be/YoAqZMgaQnc')

#price range slider (Value=50 is default)
...
#showing properties with less than price on sliders
...
#which variables to pick up additional to what we have
